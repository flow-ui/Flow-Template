...
define('input', function(require, exports, module) {
    ...
    var $ = require('jquery'),
        ...
        inputTemplate = '<input type="${type}" class="form-control" id="${id}" placeholder="${holder}" value="${text}"<!-- if: ${disable} --> disabled<!-- /if --><!-- if: ${readonly} --> readonly<!-- /if -->>';
